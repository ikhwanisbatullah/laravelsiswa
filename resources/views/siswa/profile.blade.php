									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="/siswa/{{$siswa->id}}/{{$mapel->id}}/deletenillai" class="btn btn-danger btn-sm" onClick="return confirm('Yakin mau dihapus ?')">Delete</a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
	...
	<div class="modal-dialog" role="document">
		...
		<form action="/siswa/{{$siswa->id}}/addnilai" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group{{$errors->has('nama_depan') ? 'has-error' : ''}}" >
                                    ...
                                    <input name="nilai" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nilai" value="{{old('nama_depan')}}">
                                    @if($errors->has('nilai'))
